...
@Schema(description = "Phases of the review process for a track.\n\n" +
    ...
    "BIDDING: Papers cannot be submitted now. Reviewers can bid on the papers, to indicate their expertise level. Ends after the bidding deadline for the track passes.\n\n" +
